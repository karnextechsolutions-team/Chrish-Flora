      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        >
          <div className="mb-6 select-none">
            <h2 className="font-serif text-2xl text-brown-dark font-medium mb-1">Join Chrish Flora</h2>
            <p className="font-sans text-sm text-brown/50">Create your account</p>
          </div>
